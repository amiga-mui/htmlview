...
STRPTR HTMLview_AddPart(Object *obj UNUSED, struct MUIP_HTMLview_AddPart *amsg, struct HTMLviewData *data)
{
...
VOID HTMLview_SetPath(Object *obj UNUSED, STRPTR url, struct HTMLviewData *data)
{
  /* Domain name */
  delete data->URLBase;
